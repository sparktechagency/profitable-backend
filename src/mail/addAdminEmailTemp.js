  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <p>Hello, ${data.name}</p>
        <p>Good news! A user has listed a business on ProfitableBusinessesForSale.com.</p>
          
        <h3>Business: ${data.title}</h3>
        <h3>Category: ${data.category}</h3>
        <h3>Country: ${data.country}</h3>
        
        <p>Please log in to your Dashboard to review the business and approve it.</p>
