const listingDeletionEmailTemp = (data) =>
  ` 
    <html>
      <head>
        <style>
      ...
      <body>
        <div class="container">
          ...
          <p>Hello, ${data.name}</p>
          <p>Unfortunately – Admin has deleted your listing from ProfitableBusinessesForSale.com</p>
          
          <p> Listing: ${data.title}</p>
          <p> Location: ${data.location}</p>
          <p> Date: ${new Date(data.Date).toLocaleDateString('en-GB')}</p>
          
          <p><a href="https://profitablebusinessesforsale.com/">Log In</a> to website</p>
...
export default listingDeletionEmailTemp;
